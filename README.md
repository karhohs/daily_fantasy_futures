...
If the predictions from these tools have any value, why would they be shared publicly? Primarily, because this is just for fun and spark discussion amongst friends. Assume the predictions here have no value.
